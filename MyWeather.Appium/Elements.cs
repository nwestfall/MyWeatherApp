...
namespace MyWeather.Appium
{
    public class Elements
    {
        ...
        [FindsByAndroidUIAutomator(Accessibility = "LocationEntry")]
        [FindsByIOSUIAutomation(Accessibility = "LocationEntry")]
        public IMobileElement<AppiumWebElement> GetWeatherLocationEntry;
    }
}
